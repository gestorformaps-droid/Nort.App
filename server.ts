...
async function startServer() {
  ...
  app.post("/api/activities", async (req, res) => {
    ...
    // In the Supabase architecture, new_activity updates are handled by Realtime
  ...
  app.patch("/api/activities/:id/status", async (req, res) => {
    ...
    // Fetch updated activity for broadcast
    ...
    if (updatedActivity) {
    // In the Supabase architecture, update_activity updates are handled by Realtime
    }
  ...
  app.post("/api/occurrences", async (req, res) => {
    ...
    // In the Supabase architecture, occurrences are handled by Realtime
